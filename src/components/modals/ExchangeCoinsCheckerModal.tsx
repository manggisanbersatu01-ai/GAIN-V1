...
export const COIN_EXCHANGE_COMPATIBILITY: CoinExchangeStatus[] = [
  ...
  },
  {
    ...
    pair: 'UNI/USDT',
    exchanges: {
      Binance: { supported: true, type: 'SPOT_USDT', volume24h: '$85M', status: 'OPTIMAL' },
      Bitget: { supported: true, type: 'SPOT_USDT', volume24h: '$25M', status: 'OPTIMAL' },
      OKX: { supported: true, type: 'SPOT_USDT', volume24h: '$31M', status: 'OPTIMAL' },
      Tokocrypto: { supported: true, type: 'SPOT_USDT', volume24h: '$3.5M', status: 'OPTIMAL' },
      Bybit: { supported: true, type: 'SPOT_USDT', volume24h: '$28M', status: 'OPTIMAL' },
      Indodax: { supported: true, type: 'SPOT_USDT', volume24h: '$1.8M', status: 'NORMAL' },
    },
  },
  {
    symbol: 'NEAR',
